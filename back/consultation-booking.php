...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO bookings (user_id, type, product, full_name, address, postal_code) VALUES (?, 'consultation', ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        ...
        header("Location: ../back/profile.php?success=consultation_booked");
        exit;
    } else {
